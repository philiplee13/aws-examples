...
resource "aws_iam_role_policy_attachment" "attach_s3_put_to_logging_lambda_role" {
  role       = module.logging_lambda_func.lambda_role_name
  policy_arn = aws_iam_policy.test_lambda_s3_put_policy.arn
}

resource "aws_iam_role_policy_attachment" "attach_s3_get_to_logging_lambda_role" {
  role       = module.logging_lambda_func.lambda_role_name
  policy_arn = aws_iam_policy.test_lambda_s3_get_policy.arn
}
