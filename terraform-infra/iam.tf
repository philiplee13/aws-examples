...
resource "aws_iam_policy" "test_lambda_s3_put_policy" {
  ...
  policy = templatefile("policies/grant-s3-put-access.json", {
    bucketName = aws_s3_bucket.new_bucket.bucket
  })
}
...
// attach iam policies to role generated by terraform lambda module
resource "aws_iam_role_policy_attachment" "attach_s3_put_to_sync_lambda_role" {
  role       = module.synchrnous_s3_lambda.lambda_role_name
  policy_arn = aws_iam_policy.test_lambda_s3_put_policy.arn
  depends_on = [module.synchrnous_s3_lambda]
}

resource "aws_iam_role_policy_attachment" "attach_s3_get_to_sync_lambda_role" {
  role       = module.synchrnous_s3_lambda.lambda_role_name
  policy_arn = aws_iam_policy.test_lambda_s3_get_policy.arn
  depends_on = [module.synchrnous_s3_lambda]
}

resource "aws_iam_role_policy_attachment" "attach_s3_put_to_async_lambda_role" {
  role       = module.async_s3_lambda.lambda_role_name
  policy_arn = aws_iam_policy.test_lambda_s3_put_policy.arn
  depends_on = [module.async_s3_lambda]
}

resource "aws_iam_role_policy_attachment" "attach_s3_get_to_async_lambda_role" {
  role       = module.async_s3_lambda.lambda_role_name
  policy_arn = aws_iam_policy.test_lambda_s3_get_policy.arn
  depends_on = [module.async_s3_lambda]
}
